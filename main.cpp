...
void CargarDatos(Lista &listaEquipo, Lista &ListaGrupo, Lista &listaJugadores, Lista &listaPartidos,Lista &listaFechas){
        ...
        //cargarListafechas(listaFechas);
        //ControlDeFechas(listaFechas);
        //recorrerFechas(listaFechas);

        //Lista ListaJugadoresDeEquipos;
        //JugadoresPorEquipo(listaEquipo,listaJugadores,ListaJugadoresDeEquipos);

        //recorrerListaEquipodeJugador();
}
...
void FaseDePartidos(Lista &listaEquipo, Lista &ListaGrupo, Lista &listaJugadores, Lista &listaPartidos){
   ...
   int option=99;
    ...
    while (option != 0){
        cout<<"Has escojido: Fase De Partidos,escoje que deseas modificar"<<endl;
        cout<<"ALERTA: NO SALGA DE ESTE MENU HASTA QUE ALLA FINALIZADO EL PARTIDO"<<endl;
        cout<<"----------------------------------------------------------------------------------"<<endl;
...
void FaseDeEliminacion(Lista &listaEquipo, Lista &ListaGrupo, Lista &listaJugadores, Lista &listaPartidos){
    ...
    //---------------------------------------------------------------
    crearLista(Octavos,Octavos.compara);
    crearLista(Cuartos,Cuartos.compara);
    crearLista(Semis,Semis.compara);
    crearLista(Finales,Finales.compara);
    PtrNodoLista cursor;
    //---------------------------------------------------------------

    while (option != 0){
            bool uno = false,dos = false,tres = false,cuatro = false;
        cout<<"Has escojido: Fase De Eliminacion, A que fase quiere pasar?"<<endl;
        cout<<"----------------------------------------------------------------------------------"<<endl;
        ...
        switch(option){
            case 1:
                    generarListaOctavos(listaEquipo,listaPartidos);
                    recorrerPartidos(Octavos);
                    //METER LISTA OCTAVOS EN LISTAPARTIDO bbirrar
                    break;
            case 2:
                    generarListaCuartos(listaEquipo,Cuartos);
                ...
                if(!BuscarIdExistentePartido(auxPartido,id)){
                    ...
                    while(cursor != fin()){
                        ...
                        if ( getIdPartido(partido) == id ){
                            ...
                            if( BuscarPosDeEquipoEnGrupo(ListaGrupo, getIdEquipoLPartido(partido), getIdEquipoVPartido(partido)) ){
    ...
    if(BuscarIdExistentePartido(auxPartido,id)){
        ...
        if (idequipo == equipo1){
           ...
           if( buscarJugador(auxJugadorEquipo1,idequipo,idjugador) == true){
            ...
            else cout << " no existe en ningun de los 2 equipos" << endl;
        ...
        if (idequipo == equipo2){
           ...
           if( buscarJugador(auxJugadorEquipo2,idequipo,idjugador) == true){
            ...
            else{ cout << " no esta inicializado el partido" << endl;}
